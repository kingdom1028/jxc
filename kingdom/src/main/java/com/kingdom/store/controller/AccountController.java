...
public class AccountController {
    ...
    public ModelAndView listTran(HttpServletRequest request){  
        //创建模型跟视图，用于渲染页面。并且指定要返回的页面为home页面  
        ModelAndView mav = new ModelAndView("Account/ListTran");  
        return mav;  
    }
	@RequestMapping("/DoSaveAccount")  
	@ResponseBody
    public String doSaveAccount(HttpServletRequest request){  
        return "";  
    }
