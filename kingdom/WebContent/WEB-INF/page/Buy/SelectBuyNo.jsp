...
<form action="/Buy/SelectBuyNo/?IsReturn=1" method="post">                    <div class="right">
                        <span id="simpleSearch">
                            <input class="inputText fl" id="SearchBuyKey" name="SearchBuyKey" placeholder="请输入模糊关键字" size="30" type="text" value="" />
                    ...
                    <div class="searchAdvanced" style="display: none;">
                        ...
                        <div>
                            <span class="title">业务日期</span>  <input class="inputText" id="BuyDateForm" name="BuyDateForm" onClick="WdatePicker({maxDate:&#39;#F{$dp.$D(\&#39;BuyDateTo\&#39;) || \&#39;2100-10-01\&#39;}&#39;})" readonly="true" size="10" type="text" value="" /> <span>&nbsp;&nbsp;~&nbsp;&nbsp;</span>
                            <input class="inputText" id="BuyDateTo" name="BuyDateTo" onClick="WdatePicker({minDate:&#39;#F{$dp.$D(\&#39;BuyDateForm\&#39;)}&#39;,maxDate:&#39;2100-10-01&#39;})" readonly="true" size="10" type="text" value="" />
                        </div>
                        <div>
...
<script type="text/javascript">
    ...
    function getPageParams() {
        return [{ name: 'SearchBuyKey', value: $("#SearchBuyKey").val() },
    ...
    function SelectBuy(buyId, buyNo, supplierName, supplierId, warehouseSimpleName, warehouseId,otherFee) {
        ...
        $.ajax({
            ...
            url: "/Buy/GetProductsByBuyId/",
            cache: false,
            type: "post",
            async: false,
            success: function (data) {
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.AddBuyProduct(data.Data);
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#spanSelectBuy").hide();
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#spanReturnBody").show();
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#BuyNo").val(buyNo);
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#BuyId").val(buyId);
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#spanSupplier").text(supplierName);
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#SupplierId").val(supplierId);
                parent.$("#tabs .panel:visible iframe")[0].contentWindow.$("#spanBuyNo").text(buyNo);
...
<script type="text/javascript">
    var _controller = "Buy";
    var _action = "SelectBuyNo";
    var _url = decodeURI("http://joyinwise.com/Buy/SelectBuyNo/?IsReturn=1");
