                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                                ...
                                <td align="left" width="300">
                                    <input class="inputText wf100" data-val="true" data-val-length="不能超过30个字符。" data-val-length-max="30" data-val-regex="必须为字母、数字或下划线" data-val-regex-pattern="^[a-zA-Z0-9_]{1,}$" data-val-required="请输入商品编号。" id="ProductCode" name="ProductCode" type="text" value="SP20140214002" />

                                </td>
                                <td align="left" class="font999"><input id="ProductCode" name="ProductCode" type="hidden" value="SP20140214002" /></td>
                            </tr>
...
<option value="0ad21813-ccfd-432a-8251-eda9e42d3580|1">克</option>
                            ...
                            <tr style="display:none;">
                                ...
                                <td>
<input class="inputText wf100" data-val="true" data-val-regex="只能输入字母或数字。" data-val-regex-pattern="^[A-Za-z0-9]+$" disabled="disabled" id="ClassSimple" name="ClassSimple" type="text" value="" />                                </td>
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="5" id="tabProducts">
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#FFFFFF">2000.00</td>
                                            <td align="center" valign="middle" bgcolor="#FFFFFF">2000.00</td>
...
<script type="text/javascript">
    ...
    var _action = "Edit";
    var _url = decodeURI("http://joyinwise.com/ProductInfo/Edit/?ProductId=ed5876df-0c91-49d5-beef-61cfd7c38cd1");
