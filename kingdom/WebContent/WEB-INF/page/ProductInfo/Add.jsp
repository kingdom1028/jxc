...
<form action="/ProductInfo/Add" method="post"><input data-val="true" data-val-required="The ProductId field is required." id="ProductId" name="ProductId" type="hidden" value="00000000-0000-0000-0000-000000000000" /><input data-val="true" data-val-number="字段 SOBState 必须是一个数字。" id="SOBState" name="SOBState" type="hidden" value="1" /><input data-val="true" data-val-required="请选择商品分类" id="ClassId" name="ClassId" type="hidden" value="00000000-0000-0000-0000-000000000000" /><input data-val="true" data-val-number="字段 IsToList 必须是一个数字。" data-val-required="The IsToList field is required." id="IsToList" name="IsToList" type="hidden" value="0" />    <div class="buttonArea">
        <div class="left">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                                ...
                                <td align="left" width="300">
                                    <input class="inputText wf100" data-val="true" data-val-length="不能超过30个字符。" data-val-length-max="30" data-val-regex="必须为字母、数字或下划线" data-val-regex-pattern="^[a-zA-Z0-9_]{1,}$" data-val-required="请输入商品编号。" id="ProductCode" name="ProductCode" type="text" value="SP20140215002" />

                                </td>
                                <td align="left" class="font999"><input id="ProductCode" name="ProductCode" type="hidden" value="SP20140215002" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" class="font999">
                                    <span class="field-validation-valid" data-valmsg-for="ProductName" data-valmsg-replace="true"></span><span style="position: absolute; margin-top: -10px;">商品名称、规格、单位三个字段确定该商品的唯一性。</span></td>
                            </tr>
                            <tr>
                                <td align="right" class="font14"><font color="red">*</font>单位
                                </td>
                                <td>
                                    <select class="DropDown easyui-combobox" data-val="true" data-val-required="请选择单位" id="StrProductUnit" name="StrProductUnit" onchange="ValidateUnit()" style="width:300px;"><option value="5bb55d35-453a-4de4-a059-633053fd8a17|1">台</option>
...
<input class="inputText wf100" data-val="true" data-val-regex="只能输入字母或数字。" data-val-regex-pattern="^[A-Za-z0-9]+$" id="ClassSimple" name="ClassSimple" onchange="SetClassSimple()" type="text" value="" />                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="0" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="ProductSalePriceStr" name="ProductSalePriceStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                                </td>
                                <td align="left" class="font999">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="0" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="ProductCostPriceStr" name="ProductCostPriceStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                                </td>
                                <td align="left" class="font999">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="-9999999999" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="LowSalePricePerStr" name="LowSalePricePerStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                                </td>
                                <td align="left" class="font999">
                            ...
                            <tr style="display: none">
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="-9999999999" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="HighSalePricePerStr" name="HighSalePricePerStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                                </td>
                                <td align="left" class="font999">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="-9999999999" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="LowStockCountStr" name="LowStockCountStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="inputText wf100" data-val="true" data-val-range="数值超出合理的范围" data-val-range-max="9999999999" data-val-range-min="-9999999999" data-val-regex="请输入正确的数值。" data-val-regex-pattern="^(-?\d+)(\.\d+)?$" id="HighStockCountStr" name="HighStockCountStr" onchange="if(isNumber($(this).val())){$(this).val(Number($(this).val()).toFixed(2));}" type="text" value="" />
                ...
                <input type="hidden" id="hidProductWarehouseTip" value="0" />
                <input type="hidden" name="hidProductsSn" value="" />
                <input type="hidden" name="hidDeleteSerialNo" />
                    <div class="height10" id="divproductStockListhead" style="display:none"></div>
                    <div class="wf100 shadowBoxWhite whiteBox property" id="divproductStockList"  style="display:none">
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="5" id="tabProducts">
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#FFFFFF">0.00</td>
                                            <td align="center" valign="middle" bgcolor="#FFFFFF">0.00</td>
                                            <td align="center" valign="middle" bgcolor="#FFFFFF">0.00</td>
                ...
                <div class="wf100 shadowBoxWhite whiteBox property" style="margin-top:10px;" id="wfproperty">
    ...
    $(document).ready(function () {
        ...
        if (isToList == 1 ||isToList==2) {
            parent.childAddTab('商品列表', '/ProductInfo/List?IsToList=' + isToList, '基础资料');
        }
        

        //加载商品分类简写
        InitClassSimple();
        $('#StrProductUnit').combobox({
    ...
    $.ajax({
        ...
        url: "/ProductInfo/GetSerialNoJson/",
        cache: false,
        type: "post",
        async: false,
        success: function (data) {
            for (var i = 0, j = data.length; i < j; i++) {
                var snostr = $("#sno" + data[i].TitleId).val();
                var snrStr = $("#snr" + data[i].TitleId).val();
                $("#sno" + data[i].TitleId).val(snostr + data[i].Sn + ";");
                $("#snr" + data[i].TitleId).val(snrStr + data[i].remark + ";")
            }
        },
        error: function () {
        }
    ...
    function Save(type) {
        ...
        if (result) {
            ...
            $("form:eq(0)").attr("action", "/ProductInfo/Add").submit();
        }
    }
    ...
    function calSaleAmt(obj) {
        ...
        if (Number(initStockPrice) >= 1000000000 && initStockPrice != "") {
            Dialog.alert("期初单价不能超过十亿元。", function () {
        ...
        if (Number(initStockAmt) > 1000000000 && initStockAmt != "") {
            Dialog.alert("期初总金额不能超过十亿元。", function () {
                $("#SaleAmt").addClass("input-validation-error");
            });
            return;
        }
    ...
    function showOpenSnManage() {
        ...
        if (sobstate == "0") {
            ...
            var hidProductWarehouseTip = $("#hidProductWarehouseTip").val();
            if (hidProductWarehouseTip == "0") {
                var productId;
                if ($("#ProductId").val() != "") {
                    productId = $("#ProductId").val();
                }
                ...
                parent.$('#openIframe')[0].src = "/ProductInfo/ProductWarehouseStoreList?productId=" + productId;
                parent.$('#openFrameDiv').dialog('open');
                $("#hidProductWarehouseTip").val("1");
            }
            else {
                parent.$('#openFrameDiv').dialog('open');
            }
...
<script type="text/javascript">
    ...
    var _action = "Add";
    var _url = decodeURI("http://joyinwise.com/ProductInfo/Add");
