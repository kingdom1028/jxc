...
<body>
    ...
    <tr>
        <td valign="top">
            <div class="shadowBoxWhite newMember2 wf100">
                <div class="step">
                    <ul>
                        <li><a href="/NewStart/BasicInformation/" class="stepN"><span class="icon">1</span><span class="text">基本资料</span></a></li>
                        <li><a href="javascript:;" class="stepS"><span class="icon">2</span><span class="text">期初建账</span></a></li>
                ...
                <!-- step -->
                <div class="info">
                    开始使用智慧商贸记账以前，将商品、往来账目等做一下盘点，将商品数量，现金存款金额等数据录入到智慧商贸系统中。
                </div>
                <div class="clear"></div>
                <!-- info -->
                <div class="content">
                    <div style="width: 390px; margin: 50px;">
                        <a href="javascript:;" onclick="parent.childAddTab('结算账户','/Account/List','系统设置')" class="metroCyan metro110" style="margin-right: 10px;"><span class="icon">
                            <img src="../../Content/themes/default/images/membericon5.png"></span><span class="text">结算账户</span></a>
                        <a href="javascript:;" onclick="parent.childAddTab('收支项目管理','/Project/List','系统设置')" class="metroRed2 metro110" style="margin-right: 10px;"><span class="icon">
                            <img src="../../Content/themes/default/images/membericon6.png"></span><span class="text">收支项目管理</span></a>
                        <a href="javascript:;" onclick="parent.childAddTab('业务设置','/SysConfig/Config','系统设置')" class="metroPurple2 metro110"><span class="icon">
                            <img src="../../Content/themes/default/images/membericon8.png"></span><span class="text">业务设置</span></a>
                    </div>
                </div>
                <!-- content -->
            </div>
...
<script type="text/javascript">
    ...
    var _action = "BeginAccount";
    var _url = decodeURI("http://joyinwise.com/NewStart/BeginAccount/");
    var _source = decodeURI("http://joyinwise.com/NewStart/BasicInformation");
    $.ajax({
        type: "GET",
