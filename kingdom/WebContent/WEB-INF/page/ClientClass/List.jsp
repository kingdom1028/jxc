...
<form action="/ClientClass/List" method="post">  <input type="text" style="display:none;" />
        <div class="right">
            <span id="simpleSearch">
                <input class="inputText fl" id="SearchClassName" name="SearchClassName" placeholder="请输入客户分类名称" size="30" type="text" value="" />
                ...
                <tr>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" align="center">
                            <input type='checkbox' selable='1' value='1bab9135-7b4f-4c2d-a9c0-4fd80c752e91' /></td>
                        <td bgcolor="#FFFFFF" align="center">
                            1
                        </td>
                        ...
                        <td align="center" bgcolor="#FFFFFF">
                            <a class="operate edit PERM_VIEW" onclick="editRecord('1bab9135-7b4f-4c2d-a9c0-4fd80c752e91','默认分类')" title="编辑"></a>
                            <a class="operate del PERM_DELETE" onclick="deleteRecord('1bab9135-7b4f-4c2d-a9c0-4fd80c752e91')" title="删除"></a>
                        </td>
                    </tr> 
                <tr id="lastLine">
    ...
    $(document).ready(function () {
        ...
        <td width="315" valign="top">
            ...
            <div class=" quickAdd shadowBoxYellow" id="divAdd">
                <div class="title" id="divAddTitle">新增客户分类</div>
                <div class="text">
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        <tr>
                            <td valign="top" class="font14">客户分类名称</td>
                            <td>
                                <input type="hidden" id="hidClassId" name="hidClassId"/>
                                <input name="ClientClassName" type="text" class="inputText" />
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
...
<script type="text/javascript">
    ...
    function doIncome() {
        ...
        var $e_classname = $("input[name='ClientClassName']");
        ...
        if (param["model.ClassName"].length>20) {
            ShowMsg("客户分类名称长度不能超过20!");
            return;
        }
        $.post("/ClientClass/Save/", param, function (result, resultState) {
    ...
    function editRecord(ClassId, ClassName) {
        ...
        $("input[name='ClientClassName']").val(ClassName);
        $("#divAddTitle").text("编辑客户分类");
        $("#btnBack").show();
    }
    ...
    function editBack() {
        ...
        $('#divAddTitle').text('新增客户分类');
        $("input[name='hidClassId']").val('');
        $("input[name='ClientClassName']").val('');
        $("#btnBack").hide();
    }
    ...
    function deleteRecord(arg) {
        ...
        $.messager.confirm('系统提示', '是否删除选中的数据？', function (r) {
            if (r) {
                executeAjax("/ClientClass/Delete/", cids, "删除客户分类", "reload()");
            }
        });

    }
    function getPageParams() {
        return [{ name: 'ClassName', value: $("#SearchClassName").val() }
        ];
    }
</script>
...
<script type="text/javascript">
    var _controller = "ClientClass";
    var _action = "List";
    var _url = decodeURI("http://joyinwise.com/ClientClass/List");
