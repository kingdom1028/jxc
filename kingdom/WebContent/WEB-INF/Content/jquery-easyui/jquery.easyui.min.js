...
if(_66){
_65.href=_66;
$(_63).attr("href","javascript:void(1)");
}
if(_63.onclick){
...
var _297 = $("<a style=\"cursor:pointer\" class=\"tabs-inner\"></a>").appendTo(opts.tab);
...
var _29a = $("<a style=\"cursor:pointer\" class=\"tabs-close\"></a>").appendTo(opts.tab);
...
$("<a style=\"cursor:pointer\" class=\"tabs-close\"></a>").appendTo(tab);
}else{
...
$(function () {
    $(".combo-text").change(function () {
        if ($(".combo-value").val() == '' || $(".combo-value").val() == '00000000-0000-0000-0000-000000000000') {
            $(".combo").addClass("select-validation-error");
            return false;
        } else {
            $(".combo").removeClass("select-validation-error");
        }
    });
    $(".combobox-item").click(function () {
        if ($(".combobox-item-selected").attr('value') == '' || $(".combobox-item-selected").attr('value') == '00000000-0000-0000-0000-000000000000') {
            $(".combo").addClass("select-validation-error");
            return false;
        } else {
            $(".combo").removeClass("select-validation-error");
